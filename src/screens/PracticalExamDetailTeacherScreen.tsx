...
const PracticalExamDetailTeacherScreen = () => {
  ...
  const handleDeadlineChange = async (newDeadline: string) => {
    ...
    try {
      ...
      // Convert Vietnam time to UTC ISO string
      ...
      if (classAssessment && classAssessment.id) {
        ...
        showErrorToast(
          'Error',
          'This exam does not have an assessment template. Please create a template first to set the deadline.',
        );
        return;
      }
...
export default PracticalExamDetailTeacherScreen;
